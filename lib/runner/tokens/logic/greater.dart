...
class ArrowGreaterToken extends ArrowToken {
  ArrowToken left;
  ArrowToken right;

  ArrowGreaterToken(this.left, this.right, ArrowVM vm, String file, int line) : super(vm, file, line);
  ...
  ArrowResource get(ArrowLocals locals, ArrowGlobals globals, ArrowStackTrace stackTrace) {
    ...
    stackTrace.push(ArrowStackTraceElement("Greater", file, line));
    final result = l.greater(r);
    stackTrace.pop();
